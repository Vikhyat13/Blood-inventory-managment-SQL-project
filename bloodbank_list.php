    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          <h1 class="page-title">List of Blood Banks</h1>
        </div>
      </div>
      <hr>
        ...
        <table class="table table-bordered table-striped table-hover">
          <thead class="thead-dark">
            <tr>
              ...
              // Fetch column names from the BloodBank table
              $sql_columns = "SHOW COLUMNS FROM BloodBank";
          ...
          <tbody>
            <?php
            // Fetch all rows from the BloodBank table
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<tr><td colspan="' . mysqli_num_fields($result_columns) . '" class="text-center">No blood banks found.</td></tr>';
            }
            ?>
          </tbody>
        </table>
