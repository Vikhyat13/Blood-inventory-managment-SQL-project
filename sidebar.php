...
<div class="sidebar"><b>
  ...
  <a href="hospital_list.php" <?php if ($active == 'hospital') echo "class='act'"; ?>>
    <span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;Registered Hospitals
  </a>

  <!-- Registered Blood Banks -->
  <a href="bloodbank_list.php" <?php if ($active == 'bloodbank') echo "class='act'"; ?>>
    <span class="glyphicon glyphicon-tint"></span>&nbsp;&nbsp;Registered Blood Banks
  </a>

  <!-- Check Contact Us Query -->
